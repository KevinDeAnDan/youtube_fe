...
<div id="header">
    <div class="header-one">
        <div class="header__list">
            <font-awesome-icon class="header__list-icon" icon="fa-solid fa-bars" />
        </div>
        <div class="header__logo">
            <svg class="header__logo-icon" viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;">
    ...
    <div class="header-two">
        <form class="header__search" action="">
            ...
            <font-awesome-icon class="header__search-icon" icon="fa-solid fa-magnifying-glass" />
            <font-awesome-icon class="header__keybroad-icon" icon="fa-solid fa-keyboard" />
            <button><font-awesome-icon icon="fa-solid fa-magnifying-glass" /></button>
        </form>
        
        <div class="header__micro">
            <font-awesome-icon class="header__micro-icon" icon="fa-solid fa-microphone" />
        </div>
    </div>
    <div class="header-three">
        <div class="header__upload">
            <font-awesome-icon class="header__upload-icon" icon="fa-solid fa-upload" />
        </div>
        <div class="header__table">
            <font-awesome-icon class="header__table-icon" icon="fa-solid fa-table-cells" />
        </div>
        <div class="header__bell">
            <font-awesome-icon class="header__bell-icon" icon="fa-solid fa-bell" />
        </div>
...
.header__search-input:focus {
    border: 1px solid #195bb8;
}
.header__keybroad-icon {
    position: absolute;
    right: 14px;
    top: 9px;
    font-size: 1.2rem;
